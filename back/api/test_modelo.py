...
# Parâmetros    
url_dados = "database/TravelInsurancePrediction.csv"
colunas = ['Age','Employment Type','GraduateOr0t','AnnualIncome','FamilyMembers','ChronicDiseases','FrequentFlyer','EverTravelledAbroad','TravelInsurance']
